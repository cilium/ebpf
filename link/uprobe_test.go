...
func TestUprobeToken(t *testing.T) {
	tests := []struct {
		...
		{probeArgs{path: "/bin/bash", offset: 0, refCtrOffset: 0}, "/bin/bash:0x0"},
		{probeArgs{path: "/bin/bash", offset: 1, refCtrOffset: 0}, "/bin/bash:0x1"},
		{probeArgs{path: "/bin/bash", offset: 65535, refCtrOffset: 0}, "/bin/bash:0xffff"},
		{probeArgs{path: "/bin/bash", offset: 65536, refCtrOffset: 0}, "/bin/bash:0x10000"},
