...
var elfSectionDefs = []libbpfElfSectionDef{
	...
	{"tracepoint.s+", sys.BPF_PROG_TYPE_TRACEPOINT, 0, _SEC_SLEEPABLE},
	{"tp.s+", sys.BPF_PROG_TYPE_TRACEPOINT, 0, _SEC_SLEEPABLE},
	{"raw_tracepoint+", sys.BPF_PROG_TYPE_RAW_TRACEPOINT, 0, _SEC_NONE},
	{"raw_tp+", sys.BPF_PROG_TYPE_RAW_TRACEPOINT, 0, _SEC_NONE},
	{"raw_tracepoint.s+", sys.BPF_PROG_TYPE_RAW_TRACEPOINT, 0, _SEC_SLEEPABLE},
	{"raw_tp.s+", sys.BPF_PROG_TYPE_RAW_TRACEPOINT, 0, _SEC_SLEEPABLE},
	...
	{"tp_btf.s+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_RAW_TP, _SEC_ATTACH_BTF | _SEC_SLEEPABLE},
	...
	{"fsession.multi+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_FSESSION_MULTI, 0},
	{"fsession.multi.s+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_FSESSION_MULTI, _SEC_SLEEPABLE},
	{"fentry.multi+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_FENTRY_MULTI, 0},
	{"fexit.multi+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_FEXIT_MULTI, 0},
	{"fentry.multi.s+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_FENTRY_MULTI, _SEC_SLEEPABLE},
	{"fexit.multi.s+", sys.BPF_PROG_TYPE_TRACING, sys.BPF_TRACE_FEXIT_MULTI, _SEC_SLEEPABLE},
