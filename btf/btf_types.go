...
func parseBTFHeader(buf []byte) (*btfHeader, *btfHeaderLayout, binary.ByteOrder, error) {
	...
	var layout *btfHeaderLayout
	if remainder >= int64(binary.Size(&btfHeaderLayout{})) {
		layout = new(btfHeaderLayout)
