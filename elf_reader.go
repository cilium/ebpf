...
func (ec *elfCode) loadFunctions(section *elfSection) (map[string]asm.Instructions, error) {
	...
	for {
		...
		// Up to clang9, calls to subprograms within the same ELF section are
		// encoded using backward jumps. When splitting sections into
		// subprograms, these other subprograms are no longer in scope.
