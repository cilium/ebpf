...
func LoadCollectionSpecFromReader(rd io.ReaderAt) (*CollectionSpec, error) {
	...
	var (
		...
		windowsPlatformSection *elf.Section
	...
	for i, sec := range f.Sections {
		...
		case strings.HasPrefix(sec.Name, "version"):
			versionSection = sec
		case sec.Name == ".ebpf_for_windows":
			windowsPlatformSection = sec
...
func (ec *elfCode) loadFunctions(section *elfSection) (map[string]asm.Instructions, error) {
	...
	insns, err := asm.AppendInstructions(insns, r, ec.ByteOrder, ec.platform)
	if err != nil {
