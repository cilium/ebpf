...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc $BPF_CLANG -cflags $BPF_CFLAGS bpf redirect.c -- -I../headers
...
func main() {
	...
	attachFilter("eth0", objs.bpfPrograms.Redirect)
