...
// AssociateMap updates all map loads containing a Reference to the given
// symbol to load from an open, existing Map m instead.
//
// Returns ErrUnreferencedSymbol error if the symbol isn't used.
