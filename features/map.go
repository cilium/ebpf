...
func probeCgroupStorageMap(mt sys.MapType) error {
	...
	return probeMapVerbatim(&sys.MapCreateAttr{
		MapType:    mt,
		ValueSize:  4,
...
func probeStorageMap(mt sys.MapType) error {
	...
	err := probeMapVerbatim(&sys.MapCreateAttr{
		MapType:        mt,
		KeySize:        4,
		ValueSize:      4,
		MaxEntries:     0,
...
func probeMap(attr *sys.MapCreateAttr) error {
	...
	attr.MaxEntries = 1
	return probeMapVerbatim(attr)
}

func probeMapVerbatim(attr *sys.MapCreateAttr) error {
