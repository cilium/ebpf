...
//go:generate go run golang.org/x/tools/cmd/stringer -output types_string.go -type=MapType,ProgramType,PinType
...
//go:generate go run golang.org/x/tools/cmd/stringer -type AttachType -trimprefix Attach
