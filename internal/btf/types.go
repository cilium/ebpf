...
// Transform modifies a given Type and returns the result.
//
...
func Copy(typ Type, transform Transform) Type {
	copies := make(copier)
...
func copyTypes(types []Type, transform Transform) []Type {
...
func (c copier) copy(typ *Type, transform Transform) {
	var work typeDeque
