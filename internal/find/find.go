...
func TargetInKernel[T btf.Type](typeName string, target *T, cache *btf.Cache) (*btf.Spec, *btf.Handle, error) {
	...
	if errors.Is(err, btf.ErrNotFound) {
		spec, module, err := targetInModule(typeName, target, cache)
		if err != nil {
...
// targetInModule attempts to find a named type in any loaded module.
//
...
func targetInModule[T btf.Type](typeName string, target *T, cache *btf.Cache) (*btf.Spec, *btf.Handle, error) {
