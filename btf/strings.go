...
func readStringTable(r sizedReader, baseStrings *stringTable) (*stringTable, error) {
	...
	if baseStrings != nil {
		...
		firstStringOffset = baseStrings.offsets[idx] + uint32(len(baseStrings.strings[idx])) + 1
	}
...
func (st *stringTable) Lookup(offset uint32, baseStringTable *stringTable) (string, error) {
