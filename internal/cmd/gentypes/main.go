...
// replaceUnionWithBytes replaces the union with bytes at struct.
// you can specify the union name or the union position at struct.
// the position can be -1, it means the first union in struct will be replaced
// otherwise if the position or name specified, it replaces exactly the specified
