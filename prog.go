...
type RunOptions struct {
	...
	// If the data output from the kernel is larger than the provided buffer, Run will panic.
	DataOut []byte
	...
	CPU uint32
	// Called whenever the syscall is interrupted, and should be set to testing.B.ResetTime
